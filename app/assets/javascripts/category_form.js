$(function() {
  ...
  var cate_select = $("#kawa-categories");
  ...
  function appendSelect(cateNum) {
    ...
    var html =
    `<div class="kawa-sell-form__content__box__group__select" id="${ container_id }">
      <i class="fa fa-chevron-down kawa-arrow-bottom"></i>
      <select name="item[category_id]" id="${ select_id }" class="kawa-sell-form__content__box__group__select__wrap">
        <option value>---</option>
      </select>
    </div>`
